...
class Manufacture:
    ...
    @property
    def all(self):
        return str(f"подсчет расхода ткани {(self.size / 6.5 + 0.5) + (self.growth * 2 + 0.3)}")

clothes = Manufacture(50, 34)

print(f"расхода ткани для пальто {clothes.coat()}")
print(f"расхода ткани для костюма {clothes.costume()}")
print(f"Общий {clothes.all}")